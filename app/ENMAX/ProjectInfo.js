            ...
            >
              <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  ...
                  requires that the team work closely with project stakeholders,
                  plan the project carefully, execute according to plan, and
                  solve problems efficiently. The PROJ-304 Course focuses on
                  fundamental principles of project management. Students will
                  examine basic project management practices for initiating and
                  defining the scope of a project, planning the project,
                  executing the project with an effective project team, and
                  successfully completing the project to the client’s
            ...
            >
              <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  ...
                  especially through their advanced IT infrastructure. This idea
                  for partnership took root during my cooperative work term at
                  ENMAX in Calgary, Alberta, where, as a Digital Experience
                  Co-Op Student, I was deeply involved in their innovative IT
                  projects. My role allowed me to gain a unique perspective on
                  the integration of technology in business processes and
                  customer engagement, fostering an understanding of the pivotal
                  role IT plays in modern utility services. Witnessing their
                  progressive approach in IT solutions within the utility
                  sector, I saw a unique opportunity for collaboration. I
                  proposed this partnership to align SAIT's academic curriculum
                  with the IT practices at ENMAX. This collaboration has been
                  key in enhancing our practical learning, bridging the gap
                  between theoretical IT knowledge and its real-life
                  applications in a corporate setting, and offering us a
                  comprehensive view into the evolving world of IT within modern
                  utility companies.
                </p>
